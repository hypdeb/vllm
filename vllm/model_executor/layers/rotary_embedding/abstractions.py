...
class VanillaRotaryEmbeddingConfig:
    base: float
    max_positions: int
    dimension: int
...
class YarnRotaryEmbeddingConfig:
    ...
    rotary_embedding_config: VanillaRotaryEmbeddingConfig
    yarn_scaling_config: YarnScalingConfig


RotaryEmbeddingConfig = VanillaRotaryEmbeddingConfig | YarnRotaryEmbeddingConfig

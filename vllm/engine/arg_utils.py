...
class EngineArgs:
    ...
    flashinfer_gin_max_num_tokens: int | None = (
        ParallelConfig.flashinfer_gin_max_num_tokens
    )
    flashinfer_gin_combine_quant: bool = ParallelConfig.flashinfer_gin_combine_quant
    flashinfer_gin_zero_copy_combine: bool = (
        ParallelConfig.flashinfer_gin_zero_copy_combine
    )
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parallel_group.add_argument(
            "--flashinfer-gin-max-num-tokens",
            **parallel_kwargs["flashinfer_gin_max_num_tokens"],
        )
        parallel_group.add_argument(
            "--flashinfer-gin-combine-quant",
            **parallel_kwargs["flashinfer_gin_combine_quant"],
        )
        parallel_group.add_argument(
            "--flashinfer-gin-zero-copy-combine",
            **parallel_kwargs["flashinfer_gin_zero_copy_combine"],
        )
    ...
    def create_engine_config(
        ...
        parallel_config = ParallelConfig(
            ...
            flashinfer_gin_max_num_tokens=self.flashinfer_gin_max_num_tokens,
            flashinfer_gin_combine_quant=self.flashinfer_gin_combine_quant,
            flashinfer_gin_zero_copy_combine=(self.flashinfer_gin_zero_copy_combine),
